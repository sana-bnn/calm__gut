...
class FakeAuthCredential extends Mock implements firebase_auth.AuthCredential {}

class FakeAuthProvider extends Mock implements AuthProvider {}

void main() {
  TestWidgetsFlutterBinding.ensureInitialized();

  const email = 'test@gmail.com';
  const password = 'my_\$ecret_passw0rd';
  const user = User(
